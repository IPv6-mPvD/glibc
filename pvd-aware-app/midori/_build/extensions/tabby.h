/* tabby.h generated by valac 0.40.4, the Vala compiler, do not modify */
...
void tabby_istorage_import_session (TabbyIStorage* self,
                                    KatzeArray* tabs);
GType tabby_isession_get_type (void) G_GNUC_CONST;
KatzeArray* tabby_isession_get_tabs (TabbyISession* self);
void tabby_isession_add_item (TabbyISession* self,
                              KatzeItem* item);
void tabby_isession_attach (TabbyISession* self,
                            MidoriBrowser* browser);
void tabby_isession_restore (TabbyISession* self,
                             MidoriBrowser* browser);
...
void tabby_base_storage_import_session (TabbyBaseStorage* self,
                                        KatzeArray* tabs);
...
void tabby_base_session_add_item (TabbyBaseSession* self,
                                  KatzeItem* item);
void tabby_base_session_uri_changed (TabbyBaseSession* self,
                                     MidoriView* view,
                                     const gchar* uri);
void tabby_base_session_data_changed (TabbyBaseSession* self,
                                      MidoriView* view);
void tabby_base_session_tab_added (TabbyBaseSession* self,
                                   MidoriBrowser* browser,
                                   MidoriView* view);
void tabby_base_session_tab_removed (TabbyBaseSession* self,
                                     MidoriBrowser* browser,
                                     MidoriView* view);
void tabby_base_session_tab_switched (TabbyBaseSession* self,
                                      MidoriView* old_view,
                                      MidoriView* new_view);
void tabby_base_session_tab_reordered (TabbyBaseSession* self,
                                       GtkWidget* tab,
                                       guint pos);
...
gboolean tabby_base_session_delete_event (TabbyBaseSession* self,
                                          GtkWidget* widget,
                                          GdkEvent* event);
gdouble tabby_base_session_get_tab_sorting (TabbyBaseSession* self,
                                            MidoriView* view);
...
void tabby_base_session_set_browser (TabbyBaseSession* self,
                                     MidoriBrowser* value);
TabbySessionState tabby_base_session_get_state (TabbyBaseSession* self);
void tabby_base_session_set_state (TabbyBaseSession* self,
